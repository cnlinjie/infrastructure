 ...
 * monitor a handle, one should call {@link #monitor(Object, com.github.cnlinjie.infrastructure.util.spring.WeakReferenceMonitor.ReleaseListener)},
...
public class WeakReferenceMonitor {
    ...
    protected static Logger logger = LoggerFactory.getLogger(WeakReferenceMonitor.class);
