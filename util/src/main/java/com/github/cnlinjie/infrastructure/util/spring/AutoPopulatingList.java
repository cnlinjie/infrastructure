...
public class AutoPopulatingList<E> implements List<E>, Serializable {
	...
	/**
	 * The {@link com.github.cnlinjie.infrastructure.util.spring.AutoPopulatingList.ElementFactory} to use to create new {@link java.util.List} elements
	 * on demand.
	 */
	...
	/**
	 * Creates a new {@code AutoPopulatingList} that is backed by a standard
	 * {@link java.util.ArrayList} and creates new elements on demand using the supplied {@link com.github.cnlinjie.infrastructure.util.spring.AutoPopulatingList.ElementFactory}.
	 */
	...
	/**
	 * Creates a new {@code AutoPopulatingList} that is backed by the supplied {@link java.util.List}
	 * and creates new elements on demand using the supplied {@link com.github.cnlinjie.infrastructure.util.spring.AutoPopulatingList.ElementFactory}.
	 */
	...
	public interface ElementFactory<E> {
		 ...
		 * @throws com.github.cnlinjie.infrastructure.util.spring.AutoPopulatingList.ElementInstantiationException if the instantiation process failed
