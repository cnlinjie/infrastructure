...
package com.github.cnlinjie.infrastructure.util.spring;
...
/**
 * A {@link java.util.concurrent.ConcurrentHashMap} that uses {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.ReferenceType#SOFT soft} or
 * {@linkplain com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.ReferenceType#WEAK weak} references for both {@code keys} and {@code values}.
 *
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
	...
	/**
	 * Factory method that returns the {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.ReferenceManager}.
	 * This method will be called once for each {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Segment}.
	...
	/**
	 * Return a {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Reference} to the {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Entry} for the specified {@code key},
	...
	/**
	 * A reference to an {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Entry} contained in the map. Implementations are usually
	...
	/**
	 * A task that can be {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Segment#doTask run} against a {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Segment}.
	 */
	private abstract class Task<T> {
		 ...
		 * @see #execute(com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Reference, com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Entry)
		 */
		...
		/**
		 * Convenience method that can be used for tasks that do not need access to {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Entries}.
		 * @param reference the found reference or {@code null}
		 * @param entry the found entry or {@code null}
		 * @return the result of the task
		 * @see #execute(com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Reference, com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Entry, com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Entries)
		 */
	...
	/**
	 * Allows a task access to {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Segment} entries.
	 */
	...
	/**
	 * Strategy class used to manage {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Reference}s. This class can be overridden if
	...
	protected class ReferenceManager {
		...
		/**
		 * Factory method used to create a new {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Reference}.
		 * @param entry the entry contained in the reference
		 * @param hash the hash
		 * @param next the next reference in the chain or {@code null}
		 * @return a new {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Reference}
		 */
	...
	/**
	 * Internal {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Reference} implementation for {@link java.lang.ref.SoftReference}s.
	 */
	...
	/**
	 * Internal {@link com.github.cnlinjie.infrastructure.util.spring.ConcurrentReferenceHashMap.Reference} implementation for {@link java.lang.ref.WeakReference}s.
	 */
